...
_0x0:
	.DB  0x25,0x75,0x2F,0x25,0x30,0x32,0x75,0x2F
	.DB  0x25,0x30,0x32,0x75,0xA,0x25,0x30,0x32
	.DB  0x75,0x3A,0x25,0x30,0x32,0x75,0x3A,0x25
	.DB  0x30,0x32,0x75,0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 004B     sprintf(buff,"%u/%02u/%02u\n%02u:%02u:%02u",year,month,day,hour,minute,second);
	LDI  R30,LOW(_buff_S0000001000)
	LDI  R31,HIGH(_buff_S0000001000)
	ST   -Y,R31
	ST   -Y,R30
	__POINTW1FN _0x0,0
	ST   -Y,R31
...
; 0000 004E     lcd_puts(buff);
	LDI  R26,LOW(_buff_S0000001000)
	LDI  R27,HIGH(_buff_S0000001000)
	RJMP _0x2080004
; 0000 004F }
; .FEND
;void updateAlarm(){
